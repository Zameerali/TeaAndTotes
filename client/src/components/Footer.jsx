...
function Footer() {
  return (
    <footer className="bg-gradient-to-t from-green-800 via-green-700 to-green-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white dark:text-green-100 py-4 mt-8 shadow-inner rounded-t-2xl animate-fade-in transition-colors duration-300">
